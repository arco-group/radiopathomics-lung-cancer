...
from lib import utils, cca_concat
...
def main():
    if platform.system() == "Windows":
        ...
        result_path = r"results/cca_concatenation.csv"
        ...
        result_path = "results/cca_concatenation.csv"
    ...
    df_patrad = cca_concat.ccaFusing(df_path, df_rad)
    df_patsem = cca_concat.ccaFusing(df_path, df_sem)
    df_radsem = cca_concat.ccaFusing(df_rad, df_sem)
    df_fin = cca_concat.ccaFusing(df_patrad, df_sem)

    datasets = [df_patrad, df_patsem, df_radsem, df_fin]

    datasets_name = ["pathomics_radiomic", "pathomics_semantic", "radiomics_semantic", "pathomics_radiomic_semantic"]
