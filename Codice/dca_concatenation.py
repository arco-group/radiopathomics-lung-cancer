...
from lib import utils, dca_concat
...
def main():
    if platform.system() == "Windows":
        ...
        result_path = "results/dca_concatenation.csv"
    ...
    df_patrad = dca_concat.dcaFusing(df_path, df_rad)
    df_patsem = dca_concat.dcaFusing(df_path, df_sem)
    df_radsem = dca_concat.dcaFusing(df_rad, df_sem)
    df_fin = dca_concat.dcaFusing(df_patrad, df_sem)
